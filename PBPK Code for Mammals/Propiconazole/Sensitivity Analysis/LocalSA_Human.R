...
source(paste("C:/UXXX/Mammals/General_code/Species_PhyData.R"))
MPPGL      <- MPPGL_human
MPPGGI     <- MPPGGI_human
kdeg       <- kdeg_human
...
ka                <- 1         #calc_ka(dose.mg.kg = oral_mg.kg, Papp =  Papp_parent)
kt                <-  kt_human  
...
write.csv(NSC, paste('C:/XXX/Mammals/PPZ/SA/LocalSA_Human.csv'), row.names = TRUE)
#=============================================================================
############                End of PBPK model                    #############
#=============================================================================
